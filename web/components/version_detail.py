...
def version_detail() -> rx.Component:
    """Version detail pane: artifacts, reviews, and review nodes."""
            ...
            rx.vstack(
                ...
                rx.vstack(
                    ...
                    rx.cond(
                        ...
                        rx.text(
                            "No artifacts linked to this version.",
                            size="2",
                            color_scheme="gray",
                        ),
                    ),
                ...
                rx.vstack(
                    ...
                    rx.cond(
                        ...
                        rx.text(
                            "No reviews run for this version yet.",
                            size="2",
                            color_scheme="gray",
                        ),
                    ),
                ...
                rx.vstack(
                    ...
                    rx.cond(
                        ...
                        rx.text(
                            "No review nodes for this version yet.",
                            size="2",
                            color_scheme="gray",
                        ),
                    ),
