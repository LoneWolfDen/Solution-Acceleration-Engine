    ...
    return rx.box(
        rx.scroll_area(
            rx.vstack(
                ...
                # findings list.
                #
                # Note: the single-review "Generate Proposal" pane that used
                # to live here was removed — Gap 2's re-architecture moved
                # proposal generation to the version-level "Proposals"
                # section (see version_detail.py's proposal_form()/
                # proposals_list()), which supersedes it with multi-review
                # selection. Leaving both visible duplicated the action and
